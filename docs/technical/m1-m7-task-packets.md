...
| --- | --- | --- | --- | --- |
| M1-00A (minimal Product core) | Workspace-scoped Product aggregate/API with stable key, name, optional description, IANA timezone, lifecycle, ownership, audit/outbox events, and no roadmap-specific behavior | M0 core/API/audit dependencies complete | Workspace isolation, authorization, uniqueness, timezone, concurrency, lifecycle, migration, audit/outbox, and API contract tests | Disable routes; reverse unshipped additive migration |
...
| --- | --- | --- |
| M1-00A (minimal Product core) | M0-02 (core persistence), M0-03 (core policy), M0-07 (API/SSE) | FR-001, FR-025; AC-01-AC-02, AC-20 (the minimum Product identity, ownership, timezone, and lifecycle required before an Initiative can exist) |
