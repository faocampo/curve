...
The product boundary is approved in PRD v0.6. Remaining evidence is the supported Orca client/version, ownership and support process, license classification, MCP compatibility, delegated-auth proof, revocation behavior, and the D-007 conformance suite.
