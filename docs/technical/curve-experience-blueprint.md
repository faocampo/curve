...
| M1-01B (Curve-first Initiative shell) | [Initiative shell experience](ux-m1-01b-initiative-shell.md) (clickable list/create/detail/lifecycle prototype, state matrix, accessibility contract, and task-based review) | `REVIEW_DRAFT / MANUAL_UX_GATE_REQUIRED` | UX-006-M1-01B (clickable prototype and task-based review) and UX-007-M1-01B (work-package-linked screen contract) are prepared; internal finish review passed, while Plane implementation remains unauthorized until Federico approves the exact Curve revision. |
