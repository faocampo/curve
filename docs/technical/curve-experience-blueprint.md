...
| --- | --- | --- | --- |
| M0-S4 (API, SSE, and minimal UI implementation packet) | [Foundation probe experience](ux-m0-s4-foundation-probe.md) (clickable local foundation-status flow and screen contract) | `APPROVED_READY_FOR_IMPLEMENTATION` | UX-004-M0-S4 (clickable prototype and task-based review) and UX-005-M0-S4 (work-package-linked screen contract) were approved at exact head `a463876...` and merged through Curve PR #17 as `42ea329...`; implementation and technical acceptance remain pending. |
