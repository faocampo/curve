...
| M0-06 | L | Temporal parent-workflow skeleton, version markers, child-attempt workflow, signals, timers, cancellation, continue-as-new, and replay corpus | M0-05, M0-03, D-003 | FR-015, FR-022, NFR-004, AC-17-AC-21, AC-58 | M0-S3 (local Temporal round-trip implementation packet) is `DONE` at Plane merge `d99342f...`. M0-S6A (durable parent/child Temporal orchestration) is implemented in draft Plane PR #10 at exact head `05d2e17...`, with deterministic waves, typed/idempotent reference-only signals, pause/resume, cancellation propagation, restart recovery, Continue-As-New, and four replay histories passing; exact-head review and merge remain open. Provider-backed attempt/reconciliation integration remains later M0-06/M0-09 scope. |
...
| M0-S9A | M | Workspace-scoped ProviderConnection/ProviderCapability persistence, typed adapter registry, common error taxonomy, deterministic fake adapter, and explicit local reconciliation | M0-03, M0-05, M0-07; P0-05 and exact contract publication before dispatch | FR-003, FR-023, FR-044, NFR-005, NFR-008, NFR-013, partial AC-33 | [M0-S9A task packet](m0-s9a-provider-registry-task-packet.md) (local provider-registry scope, contracts, tests, stop conditions, and rollback); fake-provider conformance with no network, credential, callback, webhook, scheduler, model call, or public administration surface. |
...
`cb17734280260361cc3c8eccf44170a4bfbcb840`, which descends from M0-S5B merge
...
M0-S6A (durable parent/child Temporal orchestration) is implemented and locally
verified in draft Plane PR #10 at exact head `05d2e17...`; it is not accepted or
merged until Federico completes the exact-head review gate.
