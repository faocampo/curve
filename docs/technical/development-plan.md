...
| P0-12 | M | [Retention, backup, legal-hold, tombstone, and erasure decision package](p0-12-retention-decision-task-packet.md) (owner inputs, machine worksheet, approval protocol, tests, and fail-closed handoff) | D-009 (retention, deletion, backup, and legal-hold policy); data inventory; owner workshops | Current `REVIEW_DRAFT / PROPOSED`: 39 class-by-asset cells, eight controlled-copy entries, six material blocks, and six named-person approvals must become complete and bind one stable decision digest. Passing P0-12 permits separate M0-04 implementation review; protected storage and environment activation remain separately gated. |
