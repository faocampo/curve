...
| ID | Size | Deliverable | Dependencies | PRD trace | Completion evidence |
| -- | ---- | ----------- | ------------ | --------- | ------------------- |
| M1-00A | S | Minimal Product aggregate and APIs for stable key, name, optional description, IANA timezone, lifecycle, ownership, concurrency, and audit/outbox events; roadmap behavior remains in M2 | M0-02, M0-03, M0-07 | FR-001, FR-025, AC-01-AC-02, AC-20 | Workspace isolation, authorization, key uniqueness, timezone, lifecycle, concurrency, migration, audit/outbox, and API contract tests. |
