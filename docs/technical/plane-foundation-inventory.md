...
| Accepted foundation and current working tree | Foundation `549db1aea8f3307b337b3686dbb844a87549cd95`; current `origin/preview` `922dd6de5d5ed5081f35cd88343154022867ccad` | The exact foundation remains reproducible and M0-03 supplies the current accepted implementation descendant. |
