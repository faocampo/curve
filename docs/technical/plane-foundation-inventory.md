...
| Accepted foundation and current working tree | Foundation `549db1aea8f3307b337b3686dbb844a87549cd95`; current `origin/preview` `d99342f589db4eb488695487d3ae3f2c16bf0874` | The exact foundation remains reproducible and M0-S3 supplies the current accepted implementation descendant. |
