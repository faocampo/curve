...
| [RUNTIME-M0-01 task packet](runtime-m0-01-graceful-shutdown-task-packet.md) (graceful Curve worker shutdown classification, deterministic tests, live signal evidence, stop conditions, and rollback) | Bounded Plane correction at exact `preview` base `9f9bb14...` | `DEFINITION_PREPARED / OPTION 3 APPROVED / EXACT PLANE GRANT REQUIRED / NOT IMPLEMENTATION AUTHORITY` |
...
| [RUNTIME-M0-01 human execution grant](runtime-m0-01-human-execution-grant.md) (exact Plane base, file scope, Docker/VCS effects, tests, exclusions, validity, and rollback) | Separate human-operated implementation authority | `PREPARED / EXACT HUMAN APPROVAL REQUIRED / NO PLANE MUTATION` |
