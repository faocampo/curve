...
| [M1-01A implementation evidence](m1-01a-initiative-core-implementation-evidence.md) (exact context, Plane head/merge/tree, CI, tests, data boundary, and rollback) | Post-merge acceptance record for the manual-first Initiative backend foundation | `DONE_LOCAL`; M1-01 remains open for the M1-01B Curve-first Initiative shell and manual UX acceptance |
