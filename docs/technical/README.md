...
| [M1-01B Initiative shell experience contract](ux-m1-01b-initiative-shell.md) (clickable Curve-first list/create/detail/lifecycle prototype, state matrix, accessibility contract, and manual review script) | UX-006-M1-01B/UX-007-M1-01B definition gate and implementation boundary | `REVIEW_DRAFT / MANUAL_UX_GATE_REQUIRED`; Plane implementation remains unauthorized until Federico approves the exact Curve revision |
