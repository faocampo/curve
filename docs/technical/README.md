...
| [M1-00A Product core task packet](m1-00a-product-core-task-packet.md) (approved Product semantics, API, persistence, policy, Initiative guard, acceptance cases, commands, and rollback) | Exact coding-agent handoff for the minimum Product aggregate required before Initiative implementation | `PREPARED_NOT_DISPATCHABLE`; P0-05 is satisfied, while contract merge, authoritative context digest, live Plane-base revalidation, and explicit dispatch remain required |
| [M1-01A Initiative core task packet](m1-01a-initiative-core-task-packet.md) (Initiative domain/API, Product binding, three assignments, lifecycle, policy, persistence, tests, and rollback) | Exact coding-agent handoff for the local manual-first Initiative aggregate and API foundation | `PREPARED_NOT_DISPATCHABLE`; Curve merge, canonical context digest, and live Plane dispatch remain required |
