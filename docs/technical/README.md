...
| [M1-01A implementation evidence](m1-01a-initiative-core-implementation-evidence.md) (exact context, Plane head/merge/tree, CI, tests, data boundary, and rollback) | Post-merge acceptance record for the manual-first Initiative backend foundation | `DONE_LOCAL`; M1-01 remains open for M1-01B (Curve-first Initiative shell), whose UX definition is approved and whose implementation packet remains to be finalized and separately authorized |
| [M1-01B Initiative shell experience contract](ux-m1-01b-initiative-shell.md) (clickable Curve-first list/create/detail/lifecycle prototype, state matrix, accessibility contract, task review, and exact-commit evidence) | UX-006-M1-01B/UX-007-M1-01B approved definition gate and implementation boundary | `UX_APPROVED / IMPLEMENTATION_PACKET_REQUIRED` at exact tested commit `656a196...`; Plane implementation remains unauthorized until separate packet finalization and dispatch approval |
