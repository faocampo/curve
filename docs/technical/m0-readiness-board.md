...
| Published Curve contract baseline | Curve `main` at `e6e43ea7fdf99baf79922a4ae506bbcb73e7c4cb`, the squash merge of [Curve PR #37](https://github.com/faocampo/curve/pull/37) (M0-S9A post-correction lifecycle reconciliation); accepted M0-S5B evidence remains bound at `590a52ef006fd1d83bef5c76dfdab9ce9080a168` |
...
| M0-09 provider integration foundation | PARTIALLY_DECOMPOSED / IN_PROGRESS | M0-S9A is accepted for its local synthetic substrate scope. M0-S9B contains decision-bound administration, transport, callbacks/webhooks, scheduling, and real adapters. AC-57 (model-failover policy and actual-routing evidence) remains fail-closed at the parent until a dedicated Model Gateway child is defined after D-004 (model catalog and data-policy decision) and D-005 (model task-routing decision). Parent remains open. |
