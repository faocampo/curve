...
| Published Curve contract baseline | Curve `main` at `a0d21bee7f98f2477d9cfe69708a8ac043c4fc69`, the squash merge of [Curve PR #47](https://github.com/faocampo/curve/pull/47) (exact-preview local runtime refresh evidence); its ancestry includes [Curve PR #45](https://github.com/faocampo/curve/pull/45) (governance baseline reconciliation and implemented ERD), [Curve PR #30](https://github.com/faocampo/curve/pull/30) (P0-12 retention-policy decision package), [Curve PR #40](https://github.com/faocampo/curve/pull/40) (M0-S9B external-provider transport and M0-S9C Model Gateway definition gates), Curve PR #39 (M0-S9A implementation-evidence closure) at `03b26cdb...`, and accepted M0-S5B (local observability integration) evidence at `590a52ef...` |
