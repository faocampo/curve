...
| Accepted Plane baseline | Fork `preview` at `99a73b4eab5ee21fd012d7358bc9259252d47f71`; preserves the accepted local foundation from M0-S1 (Curve module shell) through M0-S6A (durable parent/child Temporal orchestration), plus M0-S9A (provider-neutral registry and reconciliation foundation), M1-00A (minimal Product core), and M1-01A (Initiative domain and API foundation) |
| Published Curve contract baseline | Curve `main` at `68a05e9f2920454752e9039d596271dbb39d6e6e`, the squash merge of [Curve PR #48](https://github.com/faocampo/curve/pull/48) (coding-agent task-packet schemas, publication chain, command boundary, and fail-closed dispatch contract); its ancestry includes [Curve PR #47](https://github.com/faocampo/curve/pull/47) (exact-preview local runtime refresh evidence), [Curve PR #45](https://github.com/faocampo/curve/pull/45) (governance baseline reconciliation and implemented ERD), [Curve PR #30](https://github.com/faocampo/curve/pull/30) (P0-12 retention-policy decision package), and [Curve PR #40](https://github.com/faocampo/curve/pull/40) (M0-S9B external-provider transport and M0-S9C Model Gateway definition gates) |
| Published Plane implementation | Plane `preview` at `99a73b4eab5ee21fd012d7358bc9259252d47f71`; its ancestry includes [Plane PR #12](https://github.com/faocampo/plane/pull/12) (M0-S9A local provider-registry implementation), Plane PR #13 (M1-00A minimal Product core), and Plane PR #14 (M1-01A Initiative domain and API foundation) |
...
| P0-12 retention decision | IN_PROGRESS / REVIEW_DRAFT | [P0-12 decision packet](p0-12-retention-decision-task-packet.md) (owner-fillable retention, backup, hold, erasure, approval, and validation plan) is machine-verifiable but D-009 remains `OPEN`. Completion requires 39 policy cells, eight controlled-copy inventory entries, six material blocks, six named-person approvals bound to one stable digest, and a scheduled review. |
...
| M0-S9C Model Gateway routing/failover | PREPARED / BLOCKED | [M0-S9C task packet](m0-s9c-model-gateway-task-packet.md) (immutable model policy, budget, OpenRouter transport, actual-route usage, failover, tests, and rollback) defines four children and owns AC-57. D-004, D-005, and D-014 remain required; D-009 applies before protected prompt/response persistence. |
