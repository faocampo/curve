...
| Published Curve baseline | Curve `main` at `72934b9b96420aa0df4ae7c0d5e1f85522003a18`, containing accepted P0-05 (test strategy and audit closure), M0-S6A (durable parent/child Temporal orchestration contract and implementation evidence), M0-S9A (provider-neutral registry and dispatch-readiness reconciliation), and P0-03A (later-milestone decision-readiness packets); accepted M0-S5B evidence remains bound at `590a52ef006fd1d83bef5c76dfdab9ce9080a168` |
...
| M0-S9A local provider-registry substrate | READY / AWAITING_EXPLICIT_DISPATCH | M0-03, M0-05, M0-07, Plane PR #9, Plane PR #10 (M0-S6A durable orchestration implementation), P0-05, local delivery, and Option B authorization are satisfied. Curve PR #29 approved head `075985a...` squash-merged the contract as `7ea9118...`; its exact-head and post-merge CI passed. [M0-S9A task packet](m0-s9a-provider-registry-task-packet.md) (scope, contracts, tests, stop conditions, and rollback) is implementation-complete. Dispatch must bind the exact merged readiness revision, regenerated canonical context digest, and still-current Plane `preview` base `ad5772c...`. Provider migration is `0005` after policy migration `0004`. D-007 is not a dependency. |
