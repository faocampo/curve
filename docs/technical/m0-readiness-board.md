...
| Published Curve baseline | Curve `main` at `7ea91188525c63d699e551910834f4602536f082`, containing accepted P0-05 (test strategy and audit closure), M0-S6A (durable parent/child Temporal orchestration contract), and the M0-S9A (provider-neutral registry and reconciliation foundation) contract; accepted M0-S5B evidence remains bound at `590a52ef006fd1d83bef5c76dfdab9ce9080a168` |
