...
| M1-01B (Initiative shell) | `IN_UX_REVIEW` | Review and approve the [M1-01B experience contract](ux-m1-01b-initiative-shell.md) (clickable Curve-first list/create/detail/lifecycle prototype, state matrix, accessibility criteria, and task-based manual review); then pin exact UI commands, Plane base, Curve context digest, and implementation acceptance |
