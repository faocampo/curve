...
| M1-01B (Initiative shell) | `UX_APPROVED / PACKET_FINALIZATION_REQUIRED` | Federico approved the [M1-01B experience contract](ux-m1-01b-initiative-shell.md) (clickable Curve-first list/create/detail/lifecycle prototype, state matrix, accessibility criteria, task-based review, and exact-commit test evidence) at `656a196...`; pin exact UI commands, Plane base, Curve context digest, implementation acceptance, and separate dispatch authority before Plane mutation |
