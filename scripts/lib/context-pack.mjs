...
export const M0_S9B2_CONTEXT_PATHS = Object.freeze(
  [
    "contracts/database/m0-s9a-provider-registry-contract.md",
    "contracts/governance/m0-s9b1-provider-administration-v1.json",
    "contracts/governance/m0-s9b2-provider-profile-v1.json",
...
export const M0_S9C1A_CONTEXT_PATHS = Object.freeze(
  [
...
const CONTEXT_PATHS = new Map([
  ...
  ["M0-S9B2", M0_S9B2_CONTEXT_PATHS],
  ["M0-S9C", M0_S9C_CONTEXT_PATHS],
  ["M0-S9C1A", M0_S9C1A_CONTEXT_PATHS],
